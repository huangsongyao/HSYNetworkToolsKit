#
# Be sure to run `pod lib lint HSYNetworkToolsKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'HSYNetworkToolsKit'
  s.version          = '0.1.0'
  s.summary          = 'A short description of HSYNetworkToolsKit.'
